...
YTPlayer: gui_keyboard.o gui_treelist.o gui_volumebar.o gui_draw_state.o input.o app.o main.o clean
	gcc -Wall -o YTPlayer app/gui/gui_keyboard.c app/gui/gui_treelist.c app/gui/gui_volumebar.c  app/gui/gui_draw_state.c app/input/input.c app/app.c main.c -lpthread -lX11 `pkg-config --libs gtk+-3.0 --cflags gtk+-3.0`
...
gui_volumebar.o: app/gui/gui_volumebar.c
	gcc -c app/gui/gui_volumebar.c -lX11 `pkg-config --libs gtk+-3.0 --cflags gtk+-3.0`

gui_draw_state.o: app/gui/gui_draw_state.c
	gcc -c app/gui/gui_draw_state.c -lX11 `pkg-config --libs gtk+-3.0 --cflags gtk+-3.0`
